...
{
    vnn_ReleaseYolo26Uint8( graph, TRUE );
...
{
    return vnn_PostProcessYolo26Uint8( graph );
}
    ...
    )
{
    ...
    return vnn_PreProcessYolo26Uint8( graph, inputs, input_num );
}
    ...
    )
{
    ...
    tmsStart = get_perf_count();
    graph = vnn_CreateYolo26Uint8( data_file_name, NULL,
