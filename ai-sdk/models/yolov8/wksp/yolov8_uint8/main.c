...
{
    vnn_ReleaseYolov8Uint8( graph, TRUE );
...
{
    return vnn_PostProcessYolov8Uint8( graph );
}
    ...
    )
{
    ...
    return vnn_PreProcessYolov8Uint8( graph, inputs, input_num );
}
    ...
    )
{
    ...
    tmsStart = get_perf_count();
    graph = vnn_CreateYolov8Uint8( data_file_name, NULL,
