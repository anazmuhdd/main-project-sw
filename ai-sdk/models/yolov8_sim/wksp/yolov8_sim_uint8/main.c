...
{
    vnn_ReleaseYolov8SimUint8( graph, TRUE );
...
{
    return vnn_PostProcessYolov8SimUint8( graph );
}
    ...
    )
{
    ...
    return vnn_PreProcessYolov8SimUint8( graph, inputs, input_num );
}
    ...
    )
{
    ...
    tmsStart = get_perf_count();
    graph = vnn_CreateYolov8SimUint8( data_file_name, NULL,
